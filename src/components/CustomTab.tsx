...
const CustomTab: React.FC<CustomTabProps> = ({
  ...
  return (
    <>
      {gameStarted && <h2 style={{ display: 'flex', justifyContent: 'center' }}>GAME STARTED</h2>}
        ...
        <Col>
          ...
          <Row>
            ...
            >
              ...
              >
                <Nav.Link eventKey="first" disabled={gameStarted}>{title1}</Nav.Link>
              </Nav.Item>
              <Nav.Item
                style={{
                  border: 'solid',
              ...
              >
                <Nav.Link eventKey="second" disabled={gameStarted}>{title2}</Nav.Link>
              </Nav.Item>
            </Nav>
          </Row>
            ...
            <Button
              ...
              onClick={() => {
                if (gameMode === "ai_vs_ai"
                  || (gameMode === "human_vs_ai" && Ai2.color == 'white')) {
                  setTurn!(true);
                }
                setGameStarted(true);
              }}
